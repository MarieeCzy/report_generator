...
class TemperatureReport(abstract.Report):
    def __init__(self, path: str, source_file: str, pre_selected_columns: list, sheet_name_: str, plot_obj_method: abstract.AbstractDataFramePlot, file_save_method: abstract.AbstractDataFrameToFile, data_trans: abstract.AbstractDataFrameTrans, post_selected_columns: abstract.AbstractGetCommonColumns):
